...
const AllTransactions = () => {
    ...
    0)
    const spentOnBills = transactions.filter((transaction) => {if (Number(transaction.amount) < 0) { return (transaction.amount)*-1}}).reduce((previousValue, currentValue) => previousValue + currentValue,
    0)
